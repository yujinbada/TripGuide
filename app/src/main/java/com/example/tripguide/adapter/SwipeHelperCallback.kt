/*
    CopyRight(c) minWachya, recyclerview drag and drop/swipe 기능 만들기, https://min-wachya.tistory.com/171
*/
...
class SwipeHelperCallback(private val recyclerViewAdapter : FinalRecyclerAdapter2)  : ItemTouchHelper.Callback() {
