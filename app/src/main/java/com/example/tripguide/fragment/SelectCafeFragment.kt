...
import com.example.tripguide.databinding.FragmentSelectCafeBinding
...
class SelectCafeFragment : Fragment(), View.OnClickListener {
    ...
    private var mBinding: FragmentSelectCafeBinding? = null
    ...
    override fun onCreateView(
        ...
        mBinding = FragmentSelectCafeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        Log.d(Constants.TAG, "SelectCafeFragment - onViewCreated() called")
    ...
    private fun fetchXML2(url: String) {
        ...
        class getDangerGrade : AsyncTask<Void, Void, Void>() {
            ...
            override fun onPostExecute(result: Void?) {
                ...
                var tagOpentimefood = false
                var tagRestdatefood = false
                var tagFirstmenu = false
                var tagReservationfood = false
                var tagInfocenterfood = false
                ...
                while (eventType != XmlPullParser.END_DOCUMENT) {
                    if (eventType != XmlPullParser.START_DOCUMENT) {
                        if (eventType == XmlPullParser.START_TAG) {
                            ...
                            if (tagName.equals("opentimefood")) tagOpentimefood = true
                            else if (tagName.equals("restdatefood")) tagRestdatefood = true
                            else if (tagName.equals("firstmenu")) tagFirstmenu = true
                            else if (tagName.equals("reservationfood")) tagReservationfood = true
                            else if (tagName.equals("infocenterfood")) tagInfocenterfood = true
                        }
                    }
                    if (eventType == XmlPullParser.TEXT) {
                        if (tagOpentimefood) {
                            ...
                            if(opentimefood != ""){
                                ...
                                binding.seletedOpentimefood.text = "영업 시간 : 문의 해주세요"
                            }
                        ...
                        if(tagRestdatefood) {
                            ...
                            else binding.selectedRestdatefood.text = "휴무일 : 문의 해주세요"
                        ...
                        if(tagFirstmenu) {
                            ...
                            else binding.selectedFirstmenu.text = "대표 메뉴 : -"
                        ...
                        if(tagReservationfood) {
                            ...
                            else binding.selectedReservationfood.text = "예약 안내 : 문의 해주세요"
                        ...
                        if(tagInfocenterfood) {
                            ...
                            else binding.selectedInfocenterfood.text = "문의 및 안내 : 문의 해주세요"
