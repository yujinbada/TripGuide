...
import com.example.tripguide.databinding.FragmentRecommendedTripBinding
...
class RecommendedTripFragment : Fragment(), View.OnClickListener {
    ...
    private var mBinding: FragmentRecommendedTripBinding? = null
    ...
    override fun onCreateView(
        ...
        Log.d(Constants.TAG, "RecommendedTripFragment - onCreateView() called")
        arrayList.clear()
        mBinding = FragmentRecommendedTripBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding.beforebtnrt.setOnClickListener(this)

        keywordParser()
        binding.rtRecycler.layoutManager = LinearLayoutManager(activity,
            LinearLayoutManager.VERTICAL,
            false)
        val customDecoration = CustomDecoration(2f, 10f, Color.GRAY)

        binding.rtRecycler.adapter = recommendRecyclerAdapter
        binding.rtRecycler.apply {
            itemAnimator = null
        }
        ...
        recommendRecyclerAdapter.setItemClickListener(object : RecommendRecyclerAdapter.OnItemClickListener {
            override fun onClick(v: View, position: Int) {
                ...
                mainActivity.addFragment(RecommendedTripFragment(), SelectTripFragment())
            }
    ...
    fun newInstant() : RecommendedTripFragment
    {
        val args = Bundle()
        val frag = RecommendedTripFragment()
        frag.arguments = args
        return frag
    }
