...
import com.example.tripguide.databinding.FragmentFestivalBinding
...
class FestivalFragment : Fragment(), View.OnClickListener {
    ...
    private var mBinding: FragmentFestivalBinding? = null
    ...
    override fun onCreateView(
        ...
        Log.d(Constants.TAG, "FestivalFragment - onCreateView() called")
        arrayList.clear()
        mBinding = FragmentFestivalBinding.inflate(inflater, container, false)
        return binding.root
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        binding.beforebtnfest.setOnClickListener(this)

        keywordParser()
        binding.festRecycler.layoutManager = LinearLayoutManager(activity,
            LinearLayoutManager.VERTICAL,
            false)
        val customDecoration = CustomDecoration(2f, 10f, Color.GRAY)

        binding.festRecycler.adapter = recommendRecyclerAdapter
        binding.festRecycler.apply {
            itemAnimator = null
        }
        ...
        recommendRecyclerAdapter.setItemClickListener(object : RecommendRecyclerAdapter.OnItemClickListener {
            override fun onClick(v: View, position: Int) {
                ...
                mainActivity.addFragment(FestivalFragment(), SelectFestivalFragment())
    ...
    fun newInstant() : FestivalFragment
    {
        val args = Bundle()
        val frag = FestivalFragment()
        frag.arguments = args
        return frag
    }
    ...
    override fun onClick(v: View?) {
        when(v?.id) {
            R.id.beforebtnfest -> {
                mainActivity.removeFragment(FestivalFragment())
            }
        }
    }
